...
var LikertGrid = /** @class */ (function () {
    ...
    Object.defineProperty(LikertGrid, "style", {
        get: function () { return ".sc-likert-grid-h   likert-grid-item.sc-likert-grid:nth-child(odd){--bg-color:#ccc}"; },
        enumerable: true,
        configurable: true
    });
    return LikertGrid;
